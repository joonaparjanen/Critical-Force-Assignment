## Critical Force Assignment

```
ASSIGNMENT

Design and implement a vending machine class library. Make it as clean as you can. Make it as production ready and maintainable as you can.
